if __name__ == "__main__":
    ...
    fVV=ROOT.TFile("files_nominal_mmt_"+options.year+"/VV.root","r")
    fData=ROOT.TFile("files_nominal_mmt_"+options.year+"/Data.root","r")
    if options.scale=="fake":
       fData=ROOT.TFile("files_nominal_mmt_"+options.year+"/DataSyst.root","r")
       fVV=ROOT.TFile("files_nominal_mmt_"+options.year+"/VVSyst.root","r")
    if options.scale=="tes":
       fVV=ROOT.TFile("files_scale_mmt_"+options.year+"/VV.root","r")
    fout=ROOT.TFile("files_nominal_mmt_"+options.year+"/Fake_"+options.scale+".root","recreate")

    dirOS_high=fout.mkdir("mmt_high")
    dirSS_high=fout.mkdir("mmt_highSS")
    dirOS_low=fout.mkdir("mmt_low")
    dirSS_low=fout.mkdir("mmt_lowSS")

    nbhist=1+28+68

    postfixName=["","_CMS_scale_t_1prong_"+options.year+"Down","_CMS_scale_t_1prong_"+options.year+"Up","_CMS_scale_t_1prong1pizero_"+options.year+"Down","_CMS_scale_t_1prong1pizero_"+options.year+"Up","_CMS_scale_t_3prong_"+options.year+"Down","_CMS_scale_t_3prong_"+options.year+"Up","_CMS_scale_t_3prong1pizero_"+options.year+"Down","_CMS_scale_t_3prong1pizero_"+options.year+"Up","_CMS_tauideff_pt20to25_"+options.year+"Down","_CMS_tauideff_pt20to25_"+options.year+"Up","_CMS_tauideff_pt25to30_"+options.year+"Down","_CMS_tauideff_pt25to30_"+options.year+"Up","_CMS_tauideff_pt30to35_"+options.year+"Down","_CMS_tauideff_pt30to35_"+options.year+"Up","_CMS_tauideff_pt35to40_"+options.year+"Down","_CMS_tauideff_pt35to40_"+options.year+"Up","_CMS_tauideff_ptgt40_"+options.year+"Down","_CMS_tauideff_ptgt40_"+options.year+"Up","_CMS_scale_met_unclustered_"+options.year+"Down","_CMS_scale_met_unclustered_"+options.year+"Up","_CMS_scale_m_etalt1p2_"+options.year+"Down","_CMS_scale_m_etalt1p2_"+options.year+"Up","_CMS_scale_m_eta1p2to2p1_"+options.year+"Down","_CMS_scale_m_eta1p2to2p1_"+options.year+"Up","_CMS_scale_m_etagt2p1_"+options.year+"Down","_CMS_scale_m_etagt2p1_"+options.year+"Up","_CMS_prefiringDown","_CMS_prefiringUp",
    "_CMS_fakeTauVT_dm0_pt20to25_"+options.year+"Up","_CMS_fakeTauVT_dm0_pt20to25_"+options.year+"Down","_CMS_fakeTauVT_dm0_pt25to30_"+options.year+"Up","_CMS_fakeTauVT_dm0_pt25to30_"+options.year+"Down","_CMS_fakeTauVT_dm0_pt30to35_"+options.year+"Up","_CMS_fakeTauVT_dm0_pt30to35_"+options.year+"Down","_CMS_fakeTauVT_dm0_pt35to40_"+options.year+"Up","_CMS_fakeTauVT_dm0_pt35to40_"+options.year+"Down","_CMS_fakeTauVT_dm0_pt40to50_"+options.year+"Up","_CMS_fakeTauVT_dm0_pt40to50_"+options.year+"Down","_CMS_fakeTauVT_dm0_pt50to60_"+options.year+"Up","_CMS_fakeTauVT_dm0_pt50to60_"+options.year+"Down","_CMS_fakeTauVT_dm0_ptgt60_"+options.year+"Up","_CMS_fakeTauVT_dm0_ptgt60_"+options.year+"Down","_CMS_fakeTauVT_dm1_pt20to25_"+options.year+"Up","_CMS_fakeTauVT_dm1_pt20to25_"+options.year+"Down","_CMS_fakeTauVT_dm1_pt25to30_"+options.year+"Up","_CMS_fakeTauVT_dm1_pt25to30_"+options.year+"Down","_CMS_fakeTauVT_dm1_pt30to35_"+options.year+"Up","_CMS_fakeTauVT_dm1_pt30to35_"+options.year+"Down","_CMS_fakeTauVT_dm1_pt35to40_"+options.year+"Up","_CMS_fakeTauVT_dm1_pt35to40_"+options.year+"Down","_CMS_fakeTauVT_dm1_pt40to50_"+options.year+"Up","_CMS_fakeTauVT_dm1_pt40to50_"+options.year+"Down","_CMS_fakeTauVT_dm1_pt50to60_"+options.year+"Up","_CMS_fakeTauVT_dm1_pt50to60_"+options.year+"Down","_CMS_fakeTauVT_dm1_ptgt60_"+options.year+"Up","_CMS_fakeTauVT_dm1_ptgt60_"+options.year+"Down","_CMS_fakeTauVT_dm10_pt20to25_"+options.year+"Up","_CMS_fakeTauVT_dm10_pt20to25_"+options.year+"Down","_CMS_fakeTauVT_dm10_pt25to30_"+options.year+"Up","_CMS_fakeTauVT_dm10_pt25to30_"+options.year+"Down","_CMS_fakeTauVT_dm10_pt30to35_"+options.year+"Up","_CMS_fakeTauVT_dm10_pt30to35_"+options.year+"Down","_CMS_fakeTauVT_dm10_pt35to40_"+options.year+"Up","_CMS_fakeTauVT_dm10_pt35to40_"+options.year+"Down","_CMS_fakeTauVT_dm10_pt40to50_"+options.year+"Up","_CMS_fakeTauVT_dm10_pt40to50_"+options.year+"Down","_CMS_fakeTauVT_dm10_pt50to60_"+options.year+"Up","_CMS_fakeTauVT_dm10_pt50to60_"+options.year+"Down","_CMS_fakeTauVT_dm10_ptgt60_"+options.year+"Up","_CMS_fakeTauVT_dm10_ptgt60_"+options.year+"Down","_CMS_fakeTauVT_dm11_pt20to25_"+options.year+"Up","_CMS_fakeTauVT_dm11_pt20to25_"+options.year+"Down","_CMS_fakeTauVT_dm11_pt25to30_"+options.year+"Up","_CMS_fakeTauVT_dm11_pt25to30_"+options.year+"Down","_CMS_fakeTauVT_dm11_pt30to35_"+options.year+"Up","_CMS_fakeTauVT_dm11_pt30to35_"+options.year+"Down","_CMS_fakeTauVT_dm11_pt35to40_"+options.year+"Up","_CMS_fakeTauVT_dm11_pt35to40_"+options.year+"Down","_CMS_fakeTauVT_dm11_pt40to50_"+options.year+"Up","_CMS_fakeTauVT_dm11_pt40to50_"+options.year+"Down","_CMS_fakeTauVT_dm11_pt50to60_"+options.year+"Up","_CMS_fakeTauVT_dm11_pt50to60_"+options.year+"Down","_CMS_fakeTauVT_dm11_ptgt60_"+options.year+"Up","_CMS_fakeTauVT_dm11_ptgt60_"+options.year+"Down","_CMS_fakeMu_pt10to15_"+options.year+"Up","_CMS_fakeMu_pt10to15_"+options.year+"Down","_CMS_fakeMu_pt15to20_"+options.year+"Up","_CMS_fakeMu_pt15to20_"+options.year+"Down","_CMS_fakeMu_pt20to30_"+options.year+"Up","_CMS_fakeMu_pt20to30_"+options.year+"Down","_CMS_fakeMu_pt30to40_"+options.year+"Up","_CMS_fakeMu_pt30to40_"+options.year+"Down","_CMS_fakeMu_ptgt40_"+options.year+"Up","_CMS_fakeMu_ptgt40_"+options.year+"Down","_CMS_fakeMu_promptSubtraction_"+options.year+"Down","_CMS_fakeMu_promptSubtraction_"+options.year+"Up"]
